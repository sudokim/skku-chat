...
document
    ...
    .addEventListener("click", () =>
        auth.authSignUp(app, document.getElementById("signup-email").value, document.getElementById("signup-pw").value)
    );
...
document
    ...
    .addEventListener("click", () =>
        auth.authSignIn(app, document.getElementById("signin-email").value, document.getElementById("signin-pw").value)
    );
